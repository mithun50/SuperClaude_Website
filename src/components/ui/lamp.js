    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className={cn(
            "absolute inset-auto right-1/2 h-32 md:h-56 overflow-visible w-full max-w-sm md:max-w-none md:w-[30rem] bg-gradient-conic via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]",
        ...
        <motion.div
          ...
          className={cn(
            "absolute inset-auto left-1/2 h-32 md:h-56 w-full max-w-sm md:max-w-none md:w-[30rem] bg-gradient-conic from-transparent via-transparent text-white [--conic-position:from_290deg_at_center_top]",
        ...
        <div className={cn("absolute inset-auto z-30 h-24 md:h-36 w-full max-w-xs md:max-w-[28rem] -translate-y-1/2 rounded-full opacity-50 blur-2xl md:blur-3xl", theme === 'dark' ? 'bg-cyan-500' : 'bg-yellow-500')}></div>
        <motion.div
          initial={{ width: "4rem" }}
        ...
        <motion.div
          ...
          className={cn("absolute inset-auto z-30 h-0.5 w-full max-w-sm md:max-w-none md:w-[30rem] -translate-y-[3rem]", theme === 'dark' ? 'bg-cyan-400' : 'bg-yellow-400')}
        ></motion.div>
